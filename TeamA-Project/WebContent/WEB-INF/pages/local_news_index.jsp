...
<table class="table">
    ...
    <div class="col-md-3">
        ...
        <ul align="center" class="nav nav-tabs" id="myTab">
            <li class="active"><a href="local_news_index">All Posts</a></li>
            <li><a href="local_news_location">Posts by location</a></li>
        ...
        <table >
            ...
            <tr>
                ...
                <td><h5>Posted by: ${item.getUsername()}</h5></td> <td> Location: ${item.getZip()}  </td>
               
            </tr>
            <tr>
            <td> <i>${item.getData()} </i></td>
            </tr>
            <tr> <td><h6>Posted on: ${item.getDate()}</h6></td></tr>
