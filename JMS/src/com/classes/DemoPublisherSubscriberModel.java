...
/*
56.* A client can register a message listener with a consumer. A message
57.* listener is similar to an event listener. Whenever a message arrives at
58.* the destination, the JMS provider delivers the message by calling the
59.* listener's onMessage method, which acts on the contents of the message.
60.*/
